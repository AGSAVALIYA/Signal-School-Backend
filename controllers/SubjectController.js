...
const createSubject = async (req, res) => {
  try {
    ...
    //get current academic year id from school table
    const currSchool = await School.findOne({ where: { id: req.admin.currentSchool } });

    const subject = await Subject.create({
      name: name,
      ClassId: classId,
      SchoolId: req.admin.currentSchool,
      AcademicYearId: currSchool.currentAcademicYear
    });
